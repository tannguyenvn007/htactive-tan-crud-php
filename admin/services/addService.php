...
if($_POST){
    ...
    $sql = "INSERT INTO services (icon, title, content) VALUES ('$icon', '$title', '$content')";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2 class="text-center">Service Lists</h2>
                    </div>
                                    ...
                                    if ($resultServices) {
                                        ...
                                        if ($numRow > 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editService.php?id=<?php echo $rows["id"]?>"><i class="fas fa-pencil-alt"></i></a>
                                                    <a href="deleteService.php?id=<?php echo $rows["id"]?>"><i class="fas fa-trash-alt"></i></a>
                                                </td>
                                            </tr><?php
                                            }
                                        }
